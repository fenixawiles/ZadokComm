"""Fixture-backed stand-in for a future Woven connector (API surface TBD —
see docs/DISCOVERY.md; if Woven exposes no API, an export sync feeds this same
interface)."""
...
FIXTURE_PATH = Path(__file__).resolve().parent / "fixtures" / "woven_clients.json"


class MockWovenConnector(CrmConnector):
    source_name = "woven"
